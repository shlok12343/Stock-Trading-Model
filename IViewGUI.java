...
public interface IViewGUI {
   ...
   */
  void showStockStats(String ticker, JFrame j);

  /**
   * Provides an interface for creating a new stock portfolio.
   */
  void showCreatePortfolio(JFrame j);
   ...
   */
  void viewExistingPortfolios(Client c, JFrame j);
   ...
   */
  void showSpecificPortfolio(SmartPortfolio p, LocalDate l, JFrame j);
   ...
   */
  void writeMessage(String s, JFrame j);
   ...
   */
  void showOptionError(JFrame j);

  /**
   * Provides an interface for adding stocks to a portfolio.
   */
  void showAddStocks(JFrame j);
   ...
   */
  LocalDate provideDate(JFrame j);
   ...
   */
  void getListCrossovers(ArrayList<LocalDate> a, JFrame j);

  /**
   * Displays options related to portfolio management, such as viewing or editing portfolios.
   */
  void showPortfolioOptions(JFrame j);

  /**
   * Creates a JButton with the specified name, action command, and action listener.
   *
   * @param name          the name of the button
   * @param actioncommand the action command associated with the button
   * @param j             the ActionListener associated with the button
   * @return the created JButton
   */
  JButton createButton(String name, String actioncommand, ActionListener j);

  /**
   * Displays a message in a JPanel.
   *
   * @param message the message to display
   * @param j       the JPanel on which the message will be displayed
   */
  void writeMessageJ(String message, JPanel j);
  ...
  /**
   * Sets the text in the view based on the provided stock controller.
   *
   * @param sc the stock controller used to set the text
   */
  void setText(IStockController sc);
